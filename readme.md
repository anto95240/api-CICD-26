...
8/ Test de performance K6 :
    - Créer un script test de charge sur une route testable 10s
    - test intermédiaire en local
    - améliorer votre API, ORM / une database / un seeds de donnée
    - a deployer
    - automatiser le lancement de ce script dans la CI
    - relancer les tests de charges, avoir un contast
    - trouvé un moyen de baisser les temps de réponses sur la route que vous tester